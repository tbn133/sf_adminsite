...
export const adminAPI = {
  ...
  getDeviceLogs: (deviceId, days = 7) => apiClient.get(`/admin/devices/${deviceId}/logs`, { params: { days } }),
...
export const exportAPI = {
  exportCSV: (deviceId, days = 7) => 
    apiClient.get('/api/export/csv', { params: { device_id: deviceId, days }, responseType: 'blob' }),
